...
print("Encoding JAICE")

# Load a second sample picture and learn how to recognize it.
jaice_image = face_recognition.load_image_file("jaice.jpg")
jaice_face_encoding = face_recognition.face_encodings(jaice_image)[0]

print("Encoding SHIVEN")

# Load a second sample picture and learn how to recognize it.
shiven_image = face_recognition.load_image_file("shiven.jpg")
shiven_face_encoding = face_recognition.face_encodings(shiven_image)[0]

print("Encoding HANSIKA")

# Load a second sample picture and learn how to recognize it.
hansika_image = face_recognition.load_image_file("hansika.jpg")
hansika_face_encoding = face_recognition.face_encodings(hansika_image)[0]
...
known_face_encodings = [
    ...
    david_face_encoding,
    jaice_face_encoding,
    shiven_face_encoding,
    hansika_face_encoding,
]
known_face_names = [
    "Aryan",
    "Ganesh",
